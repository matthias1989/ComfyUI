...
bpy.ops.wm.open_mainfile(filepath=D+r"\_work_00184.blend")
...
hair=(mi==hi)
print("00184 Hair-material faces:",int(hair.sum()),"/",nf)
...
shot((0,-3,0),"_m184_f.png"); shot((2.2,-2,0.3),"_m184_34.png")
print("done")
